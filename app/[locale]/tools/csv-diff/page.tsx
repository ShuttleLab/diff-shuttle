...
export async function generateMetadata({
  ...
  if (locale === "zh") {
    ...
    return {
      title: `${t("csvDiff.title")} | Diff Shuttle`,
      description: t("csvDiff.subtitle"),
      alternates: {
        canonical: PAGE_URL,
  ...
  if (locale === "zh") {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-4">{t("csvDiff.title")}</h1>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          <Link href="/tools/csv-diff/" className="hover:underline">
            {t("fullGuide")}
          </Link>
        </p>
      </div>
